...
<div align="center"><video src="영상_주소.mp4" width="100%" autoplay loop muted playsinline></video><p><i>▲ 고화질 워크플로우 실행 과정</i></p></div>
...
<img src="images/image-3.png" width="310">
---
...
### 🤝 2. 협업 환경 문제 
- **문제점**  
  셀프 호스팅을 통해 협업을 진행하려 했으나,   속도가 매우 느려 개발을 진행하는 데 어려움이 있었습니다.

- **해결**  
  초기에는 ngrok 링크를 통해 연결하여 협업을 진행하였고,   이후에는 클라우드 환경을 이용해 협업을 진행하였습니다.
